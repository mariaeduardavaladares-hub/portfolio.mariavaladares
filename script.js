...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const staggerObserver = new IntersectionObserver((entries) => {
    entries.forEach(entry => {
      if (entry.isIntersecting) {
        const cards = entry.target.querySelectorAll('.project-card, .skill-card, .timeline-item, .who-item, .why-item');
  ...
  document.querySelectorAll('.projects-grid, .skills-grid, .timeline, .who-grid, .why-grid').forEach(el => {
